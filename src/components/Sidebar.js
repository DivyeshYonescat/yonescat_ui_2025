...
const Sidebar = ({showMenu, id,closeButton,sendTOSms}) => {
    ...
    return <> 
        ...
        <div className={`invoice_sadebar_main ${showMenu && "active"} inset-shadow-sm inset-shadow-black-500  z-50`}>
            <div>
                <button type='button' className='close_button absolute top-5 right-5' onClick={()=>{closeButton(false)}}>
                    <Image src={"/images/main/svg/close-svgrepo-com.svg"}  alt={"close-svgrepo-com.svg"} width={20} height={20} />
                </button>

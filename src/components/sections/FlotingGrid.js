    ...
    <section className="py-16 bg-stone-800 relative overflow-hidden" data-scroll-section>
      ...
      <div ref={gridRef} className="floting-grid grid gap-7 max-w-9/12 mx-auto grid-cols-5 auto-rows-[minmax(1fr,_auto)]">
        <div className="floting-item" style={{'--grid-area':"1/1"}}>
          <Image src={'https://imgs.search.brave.com/nG1XXrjBGwj_rWKgiJkqEsDlf4PbjUpJ0kzu9eRx4Ag/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/aXN0b2NrcGhvdG8u/Y29tL3Jlc291cmNl/cy9pbWFnZXMvRnJl/ZVBob3Rvcy9GcmVl/LVBob3RvLTc0MHg0/OTItMTc0NDkxNTMz/My5qcGc'} width={400} height={300}></Image>
        </div>

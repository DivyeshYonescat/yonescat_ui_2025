  ...
  return(<>
    <div className="section-main contact-main">
      <div className="container">
        <div className="contact-inner flex justify-center items-center max-md:flex-col">
          ...
          <div className="containt-text w-[60%] max-lg:w-[50%] max-md:w-full p-[30px] max-md:px-0">

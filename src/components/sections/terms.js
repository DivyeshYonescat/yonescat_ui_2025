  ...
  return <>
    <div className="w-full">
      ...
      <div className="txt-block legal-info">
        ...
        <p>Conditions applicable to any resources provided by third parties, including those applicable to any possible grant of rights in content, result from each such third partie&apos;s terms and conditions or, in the absence of those, applicable statutory law.</p>
        ...
        <p>The Service may become inaccessible or it may not function properly with User&apos;s web browser, mobile device, and/or operating system. The owner cannot be held liable for any perceived or actual damages arising from Service content, operation, or use of this Service.</p>

...
export default function BoxSection({ImageUrl,BgColor,order,overlay,children}) {
  return <>
  {/* <div className="director-section relative" > */}
    {/* <div className="container"> */}
      ...
      {/* <div className={`card-main-box director-inner box-director-inner max-md:mt-[30px] w-full  max-md:order-1 ${BgColor} rounded-xl`}> */}
        <div className={`card-main-box-img flex items-center max-md:justify-center ${order} ${overlay}`}>
          <Image className="relative z-10 w-full h-full object-cover " src={`${ImageUrl}`} alt="director" width={400} height={700} />
        </div>
        {children}
      </div>    
    {/* </div> */}
